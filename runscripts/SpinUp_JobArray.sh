#!/bin/bash
#SBATCH --array=1-102%20                           # 50 jobs that run 10 at a time
#SBATCH --job-name=SpinUp_3000a_dt_1_dx_100_       # base job name for the array
#SBATCH --mem-per-cpu=400                          # maximum 150M per job
#SBATCH --time=4:30:00                             # maximum walltime per job
