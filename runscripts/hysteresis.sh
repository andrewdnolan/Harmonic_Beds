...
EXP='hystersis'                                         # Experiment (folder) name
...
#       s#<BED_FP>#"$BED_FP"#g;
#       s#<OUT_FP>#"$OUT_FP"#g;
#       s#<OFFSET>#"$OFFSET"#g" ./SRC/SIFs/Hysterisis_norestart.sif > "./SRC/SIFs/${RUN}.sif"
#
#
#   echo "./SRC/SIFs/${RUN}.sif"  >> Inputs.txt
#
...
#       s#<BED_FP>#"$BED_FP"#g;
#       s#<OUT_FP>#"$OUT_FP"#g;
#       s#<OFFSET>#"$OFFSET"#g" ./SRC/SIFs/Hysterisis_restart.sif > "./SRC/SIFs/${RUN}.sif"
#
#
#   echo "./SRC/SIFs/${RUN}.sif"  >> Inputs.txt
#
